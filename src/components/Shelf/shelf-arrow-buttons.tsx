...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla__button embla__button--prev hidden lg:block absolute top-1/2 -translate-y-1/2  z-10 w-5 h-8"
      type="button"
      {...restProps}
    >
...
export const NextButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla__button embla__button--next hidden lg:block absolute top-1/2 -translate-y-1/2 z-10 w-5 h-8 right-0"
      type="button"
      {...restProps}
    >
      <svg width="20" height="32" viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
